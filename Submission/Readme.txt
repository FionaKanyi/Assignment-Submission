To run this code you will need to download and setup intellij

Question Four
Branching statements in java are the statements used to jump the flow of execution from one part of a program to another.
